...
const PDFCheckList = React.forwardRef<HTMLDivElement>((props, ref) => {
				...
				<div className="col-12 col-md-8 col-lg-6 min-vh-100 content-area-main">
					<div className="content-area">
						...
						<div className="text-center mb-5">
							<h4 className="main-steps-title mt-3 mb-3">Civic Engagement Advocate</h4>
						</div>
						{/* Content Area */}
						<div className="card mt-2 border-0">
							<div className="row px-3 p-1">
								<div className="col-12">
									<div className="p-3">
										<h6 className="mt-3 mb-3 fc-title">Badges</h6>
										<div className="row">
											<div className="col-md-4 mb-3">
												<img src="/assets/silver-shield.png" alt="Silver Badge" className="border rounded-3 slider-image w-100" />
											</div>
											<div className="col-md-4 mb-3">
												<img src="/assets/gold-shield.png" alt="Gold Badge" className="border rounded-3 slider-image w-100" />
											</div>
											<div className="col-md-4 mb-3">
												<img src="/assets/iron-shield.png" alt="Iron Badge" className="border rounded-3 slider-image w-100" />
											</div>
											<div className="col-md-4 mb-3">
												<img src="/assets/iron-shield.png" alt="Iron Badge" className="border rounded-3 slider-image w-100" />
											</div>
												...
												{specialCases.map((item, index) => (
													<div key={item.id} className={`${specialCases.length > index + 1 ? "border-bottom" : ""}`}>
														<div className="w-100 d-flex align-items-center justify-content-between p-3">
															<div className="d-flex align-items-center"><span className="sc-tab-title">{item.title}</span></div>
														</div>
														<div className="" id={item.id}><div className="p-3">{parse(item.content)}</div></div>
													</div>
												))}
											</>
										)}
