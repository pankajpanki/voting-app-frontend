					...
					<div className="">
						...
						<div className="">
							<div className="text-center p-3">
								<h2 className="mt-4 home-title">VoteReady</h2>
								<h5 className="home-sub-title color-theme-1">Get ready for the 45th Federal Election</h5>
								<p className="mb-2 home-date-title color-theme-2">Date to be announced!</p>
								<p className="mb-0 home-info-text color-theme-1">This game will guide you through the voting process, so you’re informed and ready to participate in the upcoming Federal Election. Your participation matters!</p>
								<div className="p-1">
